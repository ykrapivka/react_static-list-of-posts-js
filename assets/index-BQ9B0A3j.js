...
expedita consequatur consequatur dolores quia eos et placeat`}],zc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Nc=({user:e})=>T.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Pc=({comment:e})=>T.jsxs("div",{className:"CommentInfo",children:[T.jsxs("div",{className:"CommentInfo__title",children:[T.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",T.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),T.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>T.jsx("div",{className:"CommentList",children:e.map(t=>T.jsx(Pc,{comment:t}))}),Tc=({post:e})=>T.jsxs("div",{className:"PostInfo",children:[T.jsxs("div",{className:"PostInfo__header",children:[T.jsx("h3",{className:"PostInfo__title",children:e.title}),T.jsxs("p",{children:[" Posted by  ",e.user!==void 0&&T.jsx(Nc,{user:e.user})]})]}),T.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length?T.jsx(Lc,{comments:e.comments}):T.jsxs(T.Fragment,{children:[T.jsx("hr",{}),T.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})]}),Mc=({posts:e})=>T.jsx(T.Fragment,{children:e.map(t=>T.jsx(Tc,{post:t}))}),Rc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}];function Dc(e){return zc.find(t=>t.id===e.userId)}function jc(e){return Rc.filter(t=>t.postId===e.userId)||null}const Oc=Cc.map(e=>({...e,user:Dc(e),comments:jc(e)})),Fc=()=>T.jsxs("section",{className:"App",children:[T.jsx("h1",{className:"App__title",children:"Static list of posts"}),T.jsx("div",{className:"PostList",children:T.jsx(Mc,{posts:Oc})})]});em(document.getElementById("root")).render(T.jsx(Fc,{}));
